...
Обработка ошибок API при недоступности сервера ЦБ

Оптимизация производительности при фильтрации данных

Синхронизация типов данных между моделями и API

##Применение принципов MVC:

Модели - бизнес-логика и валидация в классах

Вид - шаблоны Jinja2 с разделением ответственности

Контроллер - HTTP обработчики с маршрутизацией

##Новые знания:

Работа с HTTPServer и BaseHTTPRequestHandler

Использование Jinja2 для динамических шаблонов

Интеграция внешних REST API с обработкой ошибок

Применение @property для инкапсуляции данных

Парсинг URL через urlparse и parse_qs

#Итог: Разработано полнофункциональное клиент-серверное приложение, демонстрирующее основные принципы backend-разработки на Python с использованием современных подходов и инструментов.
